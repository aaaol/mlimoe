  ...
  $.fn.csf_expand_all = function() {
    return this.each( function() {
      $(this).on('click', function( e ) {
        ...
        // ------------- iowen.cn 改菜单展开------------------
        var $wrapper = $('.csf-wrapper');
        if($wrapper.hasClass('csf-search-all')){ 
          var $fields = $wrapper.find('.csf-section > .csf-field:not(.csf-depend-on)');
          $('.csf-search input').val('');
  ...
  $.fn.csf_search = function() {
    return this.each( function() {
      ...
      $input.on('change keyup', function() {
        ...
        if ( value.length > 1 ) { // iowen.cn 3 to 1 兼容中文
  ...
  $.fn.csf_options = function() {
    return this.each( function() {
      ...
      if ( $form_warning.length ) {
        ...
        $content.on('change keypress', ':input:not(.not-change)', function() {  // iowen.cn     ADD :not(.not-change)
